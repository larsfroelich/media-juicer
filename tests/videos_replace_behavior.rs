...
use common::{
    MetadataSizeProvider, MockImageBackend, NoopTimestampProvider, SuccessFfmpegExecutor,
};
...
use media_juicer::video_processing::{output_path_mp4, temp_output_path};
use std::fs;
